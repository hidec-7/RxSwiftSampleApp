...
class InfoCollectionViewCell: UICollectionViewCell {
    ...
    var user: UserModel? {
        didSet {
            ...
            regidenceTextField.text = user?.residence
            hobbyTextField.text = user?.hobby
            introductionTextField.text = user?.introdunction
        }
    }
    ...
    let introdunctionLabel = ProfileLabel(title: "自己紹介")
    ...
    override init(frame: CGRect) {
        ...
        let views = [[nameLabel, nameTextField], [ageLabel, ageTextField], [emailLabel, emailTextField], [regidenceLabel, regidenceTextField], [hobbyLabel, hobbyTextField], [introdunctionLabel, introductionTextField]]
